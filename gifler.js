					...
					(i = (function () {
						...
						return (
							...
							(t.decodeFrame = function (t, e) {
								var n
								return (
									(n = t.frameInfo(e)), (n.pixels = new Uint8ClampedArray(t.width * t.height * 4)), t.decodeAndBlitFrameRGBA(e, n.pixels), n
								)
							}),
							t
						)
							...
							(t.prototype._advanceFrame = function () {
								;(this._frameIndex += 1),
									this._frameIndex >= this._frames.length &&
										(0 !== this._loopCount && this._loopCount === this._loops ? this.stop() : ((this._frameIndex = 0), (this._loops += 1)))
							}),
						...
						})(
							{
									...
									function (e, n, r) {
										...
										n.exports = function (n, r) {
											...
											function C(t) {
												var e = t.stack,
													n = t.toString()
												return (e = 'string' == typeof e && e.length > 0 ? w(t) : ['    (No stack trace)']), { message: n, stack: b(e) }
											}
											function j(t, e, n) {
											...
											;(n.prototype.suppressUnhandledRejections = function () {
												...
												(n.prototype._ensurePossibleRejectionHandled = function () {
													0 === (2097152 & this._bitField) &&
														(this._setRejectionIsUnhandled(), D.invokeLater(this._notifyUnhandledRejection, this, void 0))
												}),
														...
														(X = function (t, n) {
															...
															return (
																e
																	...
																	: self.dispatchEvent && ((r = document.createEvent('CustomEvent')), r.initCustomEvent(t, !1, !0, n)),
								...
								12: [
									function (t, e, n) {
										...
										g ||
											((g = u({ CancellationError: p, TimeoutError: _, OperationalError: i, RejectionError: i, AggregateError: d })),
										...
										e.exports = function (e, n) {
											...
											function i(t, e) {
												return null != t.cancelPromise
													? (arguments.length > 1 ? t.cancelPromise._reject(e) : t.cancelPromise._cancel(), (t.cancelPromise = null), !0)
													: !1
											}
											function o() {
											...
											return (
												...
												(e.prototype._passThrough = function (t, e, n, r) {
													return 'function' != typeof t
														? this.then()
														: this._then(n, r, void 0, { promise: this, handler: t, called: !1, cancelPromise: null, type: e }, void 0)
												}),
											...
											l.inherits(a, n),
												...
												(a.prototype._promiseFulfilled = function (t, n) {
													var r = this._values,
														...
														u = this._limit
													if (0 > n) {
														if (((n = -1 * n - 1), (r[n] = t), u >= 1 && (this._inFlight--, this._drainQueue(), this._isResolved())))
															return !0
													} else {
														...
														var _ = h(l).call(p, t, n, o),
															d = c._popContext()
														if ((s.checkForgottenReturns(_, d, null !== a ? 'Promise.filter' : 'Promise.map', c), _ === f))
											...
											p.inherits(a, n),
												...
												(a.prototype._iterate = function (t) {
													...
													var n,
														...
														i = t.length
													if (
														(void 0 !== this._initialValue ? ((n = this._initialValue), (r = 0)) : ((n = e.resolve(t[0])), (r = 1)),
										...
										e.exports = function (e, n) {
											...
											var o = t('./util'),
												...
												a = function (t, e) {
													if (t.isPending()) {
														var n
														;(n = 'string' != typeof e ? (e instanceof Error ? e : new s('operation timed out')) : new s(e)),
				...
				function i(t, e, n, r) {
					...
					for (var v = 1, y = r.length; y > v; ++v) {
						var m = r[v] & u,
							...
							b = d[g]
						if (void 0 === b) {
							for (p |= _ << f, f += h; f >= 8; ) (t[e++] = 255 & p), (p >>= 8), (f -= 8), e === s + 256 && ((t[s] = 255), (s = e++))
					...
					;(this.numFrames = function () {
						...
						(this.decodeAndBlitFrameBGRA = function (e, r) {
							...
							for (var y = 8, m = 0, g = a.length; g > m; ++m) {
								var b = a[m]
								if (
									(0 === f && ((d += v), (f = l), d >= _ && ((v = 4 * h + 4 * n * (y - 1)), (d = p + (l + h) * (y << 1)), (y >>= 1))),
									b === c)
								)
									d += 4
								else {
